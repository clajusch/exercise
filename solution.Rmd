...
I firstly visualize the effect size (here the log10(odds ratio)) and the corresponding p-value with a volcano plot.

```{r echo = FALSE, fig.cap = "Volcano Plot", message = FALSE, warning = FALSE}
ggplot(subset(count_cumulated, analyze), 
       aes(x = log2RR, y = -log10(emp_pval), color = fdr<0.05)) + 
  geom_point() +
